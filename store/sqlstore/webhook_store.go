...
func NewSqlWebhookStore(sqlStore SqlStore, metrics einterfaces.MetricsInterface) store.WebhookStore {
	...
	for _, db := range sqlStore.GetAllConns() {
		table := db.AddTableWithName(model.IncomingWebhook{}, "IncomingWebhooks").SetKeys(true, "Id")
		table.ColMap("Id")
		table.ColMap("UserId")
		...
		tableo := db.AddTableWithName(model.OutgoingWebhook{}, "OutgoingWebhooks").SetKeys(true, "Id")
		tableo.ColMap("Id")
		tableo.ColMap("Token").SetMaxSize(26)
		tableo.ColMap("CreatorId")
		tableo.ColMap("ChannelId")
