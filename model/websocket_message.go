...
type WebsocketBroadcast struct {
	...
	UserId                int             `json:"user_id"`    // broadcast only occurs for this user
	ChannelId             int             `json:"channel_id"` // broadcast only occurs for users in this channel
	TeamId                int             `json:"team_id"`    // broadcast only occurs for users in this team
